...
if __name__ == '__main__':
    ...
    while True:
        ...
        if(response["status"] == "200"):                 
            ...
            with open("D:\Code\HackTest\CrowdCompute_Hackathon\src\demo\donor\\tools.py","wb") as f:
                f.write(r.content)
            call(["python","D:\Code\HackTest\CrowdCompute_Hackathon\src\demo\donor\\tools.py"])
